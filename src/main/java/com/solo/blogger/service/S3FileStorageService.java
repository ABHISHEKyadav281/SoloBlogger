...
public class S3FileStorageService {
    ...
    public void init() {
        try {
            ...
            if (accessKey != null && !accessKey.isBlank()
                ...
                System.out.println("S3: Using hardcoded credentials (local dev)");
                BasicAWSCredentials credentials = new BasicAWSCredentials(accessKey, secretKey);
                builder.withCredentials(new AWSStaticCredentialsProvider(credentials));
            } else {
                System.out.println("S3: No credentials found, using IAM Role (EC2)");
    ...
    private String generateS3Key(String postTitle, String extension) {
        System.out.println("reached to generate s3 key");
    ...
    private void validateFile(MultipartFile file) {
        System.out.println("reached to validate file");
        if (file == null || file.isEmpty()) {
            System.out.println("failed to store empty file. Please upload a valid image");
